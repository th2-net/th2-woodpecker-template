...
abstract class EventProvider(val settings: EventGeneratorSettings) {
    ...
    protected var firstBatch = true

    abstract fun getParentEventIdForBatch(): EventID
    abstract fun nextEvent(): Event
